...
var world9_scene = preload("res://world/World9.tscn")
# chram
...
var world13_scene = preload("res://world/World13.tscn")
...
func loadWorld(index):
	...
	match index:
		...
		8:
			current_world = world9_scene.instance()
		9:
		...
		12:
			current_world = world13_scene.instance()
